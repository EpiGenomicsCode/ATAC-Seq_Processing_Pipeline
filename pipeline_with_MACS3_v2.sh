...
input_dir="/home/ubuntu/atac_pip/test_dir"
fastqc_output_dir="/home/ubuntu/atac_pip/test_dir/fastqc_output"
skewer_output_dir="/home/ubuntu/atac_pip/test_dir/skewer_output"
bwa_output_dir="/home/ubuntu/atac_pip/test_dir/bwa_output"
post_align_output_dir="/home/ubuntu/atac_pip/test_dir/post_align_output"
reference_genome="/home/ubuntu/atac_pip/ref_gen/hg38.fa"
macs3_output_dir="/home/ubuntu/atac_pip/test_dir/macs3_output_hmmratac"   


post_alignment_script="/home/ubuntu/ATAC-Seq_Processing_Pipeline/post_alignment.py"
...
for BAM_FILE in "$post_align_output_dir"/*_noMT_noDups_unique.bam; do
    echo $BAM_FILE
    ...
    macs3 hmmratac -i "$BAM_FILE" -f BAMPE -n "$SAMPLE_NAME" --outdir "$SAMPLE_OUTPUT_DIR"
